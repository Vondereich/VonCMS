...
| ---- | --------------------------- | ------------ | --------- | --------- | ------ | ---------- | ----------- | ---------- | ------ | ---- | --------- |
| 1    | 🏠 **VonCMS** _(this site)_ | Custom CMS   | ✗         | –         | **A**  | **0.088s** | **0.088s**  | **0.106s** | 0.012  | 0.13 | 20        |
...
| ---- | --------------------------- | ------------ | ------ | ---------- | ----------- | ---------- | ------ | ---- |
| 1    | 🏠 **VonCMS** _(this site)_ | Custom CMS   | **A**  | **0.088s** | **0.088s**  | **0.105s** | 0.008  | 0.10 |
...
_Benchmark run: 2026-05-08 01:51 UTC+8 | Site names anonymised for public release_
