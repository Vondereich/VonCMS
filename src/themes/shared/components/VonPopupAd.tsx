...
export const VonPopupAd: React.FC<VonPopupAdProps> = ({ show, onClose, content }) => {
  ...
  return (
    ...
    >
      ...
      */}
      <div
        className={`relative w-full max-w-[95vw] md:max-w-5xl max-h-[calc(100dvh-2rem)] overflow-hidden bg-white dark:bg-slate-900 rounded-2xl shadow-2xl transform transition-all duration-300 ${
      ...
      >
        ...
        <div className="max-h-[calc(100dvh-2rem)] overflow-y-auto overscroll-contain rounded-xl bg-slate-50 dark:bg-slate-900/50">
