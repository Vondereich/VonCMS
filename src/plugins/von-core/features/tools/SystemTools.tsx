  ...
  return (
    <div className="space-y-6 animate-fade-in max-w-6xl mx-auto">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-white dark:bg-admin-panel rounded-xl shadow-xs border border-slate-200 dark:border-admin-border p-6 flex flex-col justify-between">
          <div>
      ...
      {results && (
        <div className="bg-admin-inset rounded-xl border border-white/10 p-6 overflow-hidden">
