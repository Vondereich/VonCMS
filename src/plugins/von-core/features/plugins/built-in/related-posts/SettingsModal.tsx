  ...
  return (
    ...
    >
      <div className="w-full overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-2xl dark:border-admin-border dark:bg-admin-panel">
        {/* Header */}
        <div className="flex items-center justify-between gap-3 border-b border-slate-100 bg-linear-to-r from-purple-50 to-pink-50 p-4 dark:border-admin-border dark:from-purple-900/20 dark:to-pink-900/20 sm:p-6">
          <div>
        ...
        <div className="max-h-[calc(100dvh-12rem)] space-y-6 overflow-y-auto p-4 sm:max-h-[60dvh] sm:p-6">
          ...
          <div className="space-y-2">
            ...
            <select
              ...
              className="w-full px-4 py-3 rounded-lg border border-slate-200 dark:border-admin-border bg-white dark:bg-admin-canvas text-slate-800 dark:text-white focus:ring-2 focus:ring-purple-500 outline-hidden"
            >
          ...
          {/* Display Options */}
          <div className="space-y-3 p-4 bg-slate-50 dark:bg-admin-canvas rounded-lg">
