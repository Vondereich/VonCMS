...
export const LoadMoreButton: React.FC<LoadMoreButtonProps> = ({
  ...
  const controlClassName = `
    inline-flex items-center justify-center px-8 py-3 rounded-lg font-semibold text-white
    ...
    <div className={`flex flex-col items-center py-8 ${className}`}>
      {href && !loading ? (
        <a
          href={href}
          rel="next"
          onClick={(event) => handleCrawlableLinkClick(event, onLoadMore)}
