...
Download the latest VonCMS_Deploy.zip
Upload it to your hosting (cPanel / DirectAdmin) or localhost (htdocs/)
Extract the ZIP file
Open your website URL (e.g. https://www.yourdomain.com)
