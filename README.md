...
VonCMS v1.26.2 is the current open-source release in the **v1.26 "After Hours"** series. The series opened with v1.26.0 as a focused modernization of the development toolchain, editor structure, SEO controls, public themes, and admin experience while keeping the established PHP shared-hosting runtime. You can install the Deploy ZIP on hosting, or fork the source repository to build your own themes, plugins, extensions, fixes, and release packages.
...
| Goal                                         | Start here                                                                                          |
| -------------------------------------------- | --------------------------------------------------------------------------------------------------- |
| Install VonCMS on shared hosting             | Download `VonCMS_v1.26.2_Deploy.zip` from [Releases](https://github.com/Vondereich/VonCMS/releases) |
...
1. Download `VonCMS_v1.26.2_Deploy.zip` from [Releases](https://github.com/Vondereich/VonCMS/releases).
...
- `VonCMS_v1.26.2_Deploy.zip`
- `VonCMS_v1.26.2_Source.zip`
