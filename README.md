...
VonCMS v1.26.6 is the current release in the **v1.26 "After Hours"** series. The series opened with v1.26.0 as a focused modernization of the development toolchain, editor structure, SEO controls, public themes, and admin experience while keeping the established PHP shared-hosting runtime. You can install the Deploy ZIP on hosting, or fork the source repository to build your own themes, plugins, extensions, fixes, and release packages.
...
> [!NOTE]
> Development is taking a short one-to-two-week break after v1.26.6 for stability monitoring and maintainer rest. Critical bug reports remain welcome, and regular feature development will resume afterward.
...
- `VonCMS_v1.26.6_Deploy.zip`
- `VonCMS_v1.26.6_Source.zip`
