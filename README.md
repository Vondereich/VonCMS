...
VonCMS v1.25.12 "OpenGate" is the current open-source release line. You can install the Deploy ZIP on hosting, or fork the source repository to build your own themes, plugins, extensions, fixes, and release packages.
...
| Goal                                         | Start here                                                                                           |
| -------------------------------------------- | ---------------------------------------------------------------------------------------------------- |
| Install VonCMS on shared hosting             | Download `VonCMS_v1.25.12_Deploy.zip` from [Releases](https://github.com/Vondereich/VonCMS/releases) |
...
1. Download `VonCMS_v1.25.12_Deploy.zip` from [Releases](https://github.com/Vondereich/VonCMS/releases).
...
- `VonCMS_v1.25.12_Deploy.zip`
- `VonCMS_v1.25.12_Source.zip`
